    ...
    def __init__(
        ...
        **kwargs
        ...
        video_analysis_lambda = _lambda.Function(
          ...
          "LOG_LEVEL": "INFO",
          "BUCKET_NAME": investigation_bucket.bucket_name,
          "BEDROCK_PROJECT_ARN": self.node.try_get_context("bedrockProjectArn"),
          "BEDROCK_PROFILE_ARN": self.node.try_get_context("bedrockProfileArn"),
         },
